...
public enum ButtonImages implements BitmapMethods {
    ...
    MENU_SINGLE_PLAYER(R.drawable.button_singleplayer, 128, 32, (int) (GAME_WIDTH / 3.7), (int) (GAME_WIDTH / (3.7 * 128) * 32)),
    MENU_CREATE_LVL(R.drawable.button_createlevel, 128, 32, (int) (GAME_WIDTH / 3.7), (int) (GAME_WIDTH / (3.7 * 128) * 32)),
    MENU_SEARCH_LVL(R.drawable.button_search_lvl, 128, 32, (int) (GAME_WIDTH / 3.7), (int) (GAME_WIDTH / (3.7 * 128) * 32)),
